                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-4">
                                                <a href="insertDetail.php?id=<?=$row['OrderID']?>"><button type="button" class="btn btn-warning rounded-pill" name="Detail">Add/Update</button></a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label for="contact-info-vertical">Status</label>
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="status" id="status1" value="packing" checked>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="username" class="form-control"
                                                name="username" placeholder="Current user" value ="<?=$row['username']?>" readonly>
                                        </div>
                                    </div>
